...
void popOutMenu()
{
	cout
		...
		<< "Question 1: 2D-DFT (60%)" << endl
		<< "-----------------------------------" << endl
		<< "1: 1_1 - DFT by Formula (This Costs 15 mins to Run)" << endl
		<< "2: 1_2 - DFT by OpenCV" << endl
		<< "3: 1_3 - IDFT by Formula (Run (1) First!!)" << endl
		<< "4: 1_4 - IDFT by OpenCV" << endl << endl

		<< "Question 2: Filter in Frequency Domain (20%)" << endl
		<< "-----------------------------------" << endl
		<< "5: 2_1 - Ideal LPF, Ideal HPF" << endl
		<< "6: 2_2 - Gaussian LPF and Gaussian HPF" << endl << endl

		<< "Question 3: Watermark in Frequency Domain (20%)" << endl
		<< "-----------------------------------" << endl
		<< "7: 3_1 - Apply Watermark in Frequency Domain" << endl
		<< "8: 3_2 - Apply Gaussian on Watermarked Image" << endl << endl
